        ...
        <form class="form-horizontal form-label-left" action="appinfomodifysave.do" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="hidden" id="logoPicPath" name="logoPicPath" src="/images/${appInfo.logoPicPath}"/>
            	<input type="hidden" id="logoLocPath" name="logoLocPath" value="/images/${appInfo.logoLocPath}"/>
