    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/dev/appversionModifySave.do" method="post" enctype="multipart/form-data">
			 ...
			 <div class="form-group">
			            <div class="col-md-6 col-md-offset-3">
			            	<c:if test="${appInfo.status == 3}">
			            	 <button id="send" type="submit" name="status" value="1" class="btn btn-success">保存并再次提交审核<tton>
			            	</c:if>
			              <button id="send" type="submit" class="btn btn-success">保存<tton>
			              <button type="button" class="btn btn-primary" id="back">返回<tton>
			              <br/><br/>
			            </div>
			  </div>
          <div class="clearfix"></div>
